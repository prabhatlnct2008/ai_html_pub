...
function getStepMessage(state: WorkflowState): string {
  const messages: Record<string, string> = {
    ...
    image_prompt_generation: "Creating image prompts...",
...
function getProgressMessage(state: WorkflowState): string {
  const messages: Record<string, string> = {
    ...
    image_prompt_generation: "AI is crafting image prompts tailored to your business...",
    image_generation: "Generating images for your page sections...",
...
function getProgressChatMessage(state: WorkflowState): string | null {
  const messages: Partial<Record<WorkflowState, string>> = {
    ...
    image_prompt_generation: "Creating tailored image prompts based on your business context...",
    image_generation: "Generating images for your page. This may take a moment...",
